...
export async function GET(req: NextRequest) {
  ...
  const [
    ...
    prisma.educationHistory.findMany({ where: { userId: user.id }, orderBy: { updatedAt: "desc" } }),
    prisma.userSkill.findMany({ where: { userId: user.id }, orderBy: { updatedAt: "desc" } }),
    prisma.userGoal.findMany({ where: { userId: user.id }, orderBy: { updatedAt: "desc" } }),
    prisma.documentFolder.findMany({ where: { userId: user.id }, orderBy: { updatedAt: "desc" } }),
    ...
    prisma.careerRoadmap.findMany({ where: { userId: user.id }, orderBy: { updatedAt: "desc" } }),
